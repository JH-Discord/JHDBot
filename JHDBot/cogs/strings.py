...
Yes, but only when it is really urgent, otherwise just ping a moderator or admin who is online or active in chat at that time.
...
NO, PLEASE reach out to support of the respective service/social network instead. They're getting paid for it.

**Can I send a DM to anyone in the server ?**
No, please ask that person if they're okay with DMs before sending a DM out of nowhere.

**Is there place where JHD resources are stored ?**
We have a repo into which the JHD_Bot dumps all the resources from `#resources` channel.
link - https://github.com/Fumenoid/JHD_Resources

**Is Shiptoasting channel a NSFW channel ?**
NO !! That channel is only for tech memes and SFW image posting, we have marked that channel NSFW because memes tend to contain explicit language.
...
`#tryhackme`
Channel for discussion of TryHackMe, http://tryhackme.com
...
**Hacking/Security**
`#beginners`
Channel for those new into hacking/security. Welcome! Please be respectful with your questions/responses and DO NOT put down others for not having a level of knowledge similar to yours. This is a NEWB FRIENDLY ZONE
...
`#osint-privacy`
Open Source Intelligence and privacy discussion and so forth. Do NOT doxx anyone!
...
`#wireless-hacking`
Discussion about Wi-Fi, RFID, forms of wireless hacking.
...
`#hardware-hacking`
Stuff about attacking and defending vulnerable physical hardware can go here

**Development**
`#programming`
Channel for anything programming related. 

`#webdev`
Channel for anything webdev related. 

`#certifications`
Discuss the certifications you have or want here. What they are. Which ones are useful. How to get them. etc. Do NOT ask for copyrighted content. Obtain it from legal sources. Make sure to check pins.
